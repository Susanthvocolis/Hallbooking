...
const BookingDashboard: React.FC = () => {
  ...
  return (
    <ProtectedRoute requiredRole={['venue_owner', 'service_vendor']}>
      <>
        <Header title="Booking Dashboard" />
                  ...
                  {filteredBookings.map((b) => (
                    <tr key={b.id} className="border-b last:border-0">
                      ...
                      <td className="py-3 px-4">
                        <span
                          className={`px-4 py-1 rounded-full text-sm font-semibold ${badgeClasses[b.bookingStatus]
                            }`}
                        >
                          {b.bookingStatus}
                        </span>
                      ...
                      <td className="py-3 px-4">
                        <span
                          className={`px-4 py-1 rounded-full text-sm font-semibold ${badgeClasses[b.paymentStatus]
                            }`}
                        >
                          {b.paymentStatus}
                        </span>
