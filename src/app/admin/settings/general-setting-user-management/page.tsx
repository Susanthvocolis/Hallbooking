...
const AccountLimitsSection = () => (
  <div className="mb-10">
    <h2 className="font-bold text-2xl mb-2 text-black">User Management</h2>
    <hr className="mb-6"/>
    <p className="font-semibold text-lg mb-3 text-black">Account Limits</p>
...
const AllSectionsCombined: React.FC = () => (
...
export default AllSectionsCombined;
